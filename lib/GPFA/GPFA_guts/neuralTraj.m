...
%        John Cunningham  jcunnin@stanford.edu
  ...
  fprintf('\n---------------------------------------\n');
  if ~isdir('C:/Users/limblab/Desktop/mat_resultsgpfa')
    mkdir('C:/Users/limblab/Desktop/mat_resultsgpfa');
  end
  % Make a directory for this runIdx if it doesn't already exist
  runDir = sprintf('C:/Users/limblab/Desktop/mat_resultsgpfa/mat_results/run%s', runIdx);
  if isdir(runDir)
