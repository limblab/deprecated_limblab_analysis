...
%   RARX will be removed in a future release. Use recursiveARX instead.
...
%    adm='ff', adg=lam: Forgetting factor algorithm, with forgetting factor
%                       lam
...
warning(message('Ident:simulink:recursiveEstimationObsoleteReplace','rarx','recursiveARX'));
