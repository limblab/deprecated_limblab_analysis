function [A,B,C,D,K,X0,dA,dB,dC,dD,dK,dX0] = ssdata(sys, newpar)
...
if nargout>6
   ...
   if isempty(cov)
      ...
      sys = setParameterVector(sys, th + sqrt(diag(cov)));
      %sys.ParameterVector = th + sqrt(diag(cov));
