...
%   RARMAX will be removed in a future release. Use recursiveARMAX instead.
...
warning(message('Ident:simulink:recursiveEstimationObsoleteReplace','rarmax','recursiveARMAX'));
