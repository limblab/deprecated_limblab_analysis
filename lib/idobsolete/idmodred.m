...
% This function is obsolete. Use balred to obtain reduced order
% approximations by first converting the model into state-space form.
%
% See also DynamicSystem/BALRED, IDSS.
