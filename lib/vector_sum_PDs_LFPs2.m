function result = vector_sum_PDs_LFPs2(data)
...
%v2 outputs the average rates as well as the pd and magnitude, so we can
%reconstruct the tuning curves
...
result = [pd mag avgRates]; %This gives the average rates as well as pd and magnitude