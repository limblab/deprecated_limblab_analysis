...
int rand_threshold = 100; //% of times the monkey receives a treat TODO: test this!
 ...
 *  TODO reward amount? mostly just for water? 
 */
...
void setup() {
  ...
  //handle SD card TODOOOOOOOOO
  SD.begin(4); 

  //open file named s_file TODO
