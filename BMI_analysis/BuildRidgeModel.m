function [filter, varargout]=BuildRidgeModel(binnedData, dataPath, fillen, UseAllInputsOption, PolynomialOrder, varargin)
...
%     Inputs = binnedData.emgdatabin;
 ...
 % The following calculates the linear filters (H) using ridge regression
 
 %(to apply dup and shift: %Inputs = DuplicateAndShift(Inputs,numlags);numlags = 1;)
