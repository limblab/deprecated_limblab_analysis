...
% $Id: slblocks.m 359 2009-01-23 21:00:54Z matt $
...
%
Browser(1).Library = 'limblab';
Browser(1).Name    = 'limblab';
Browser(1).IsFlat  = 0;% Is this library "flat" (i.e. no subsystems)?

Browser(2).Library = 'limblab';
Browser(2).Name    = 'limblab';
...
%
Viewer(1).Library = 'limblabviewers';
Viewer(1).Name    = 'Limblab';
...
%
Generator(1).Library = 'Limblab';
Generator(1).Name    = 'Limblab';
