function HybridFile = combineFileHalves2(Isofile,WMfile)
% Inputs:
% - Isofile: binnedData file for isometric task
% - WMfile: binnedData file for wrist movement task
...
%% First Half
binnedData = Isofile;
half = floor(length(binnedData.timeframe)/2);
...
%Normalize the EMG variance (make it 1 by dividing EMG data by its std)
