...
if nargin < 2
    ...
    convertFolders = {'04-13-14'}; % Define what dates to convert data for
end
%%%%%
...
for iFolder = 1:length(convertFolders)
    ...
    dirCB = fullfile(dataPath,'CerebusData\Generalizability',convertFolders{iFolder},'\');
    dirBDF = fullfile(dataPath,'\BDFStructs\Generalizability',convertFolders{iFolder},'\');
