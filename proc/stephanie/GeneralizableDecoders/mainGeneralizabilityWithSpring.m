...
% [crap SprBinned] = splitBinnedData(SprBinned,840,0);
...
[SprWithin_All_mfxval_R2, SprWithin_All_mfxval_vaf, SprWithin_All_mfxval_mse, Spr_All_OLPredData] = mfxval(SprBinned, options);
...
mean_SonS_All_R2 = mean(SprWithin_All_mfxval_R2);
mean_SonS_All_vaf = mean(SprWithin_All_mfxval_vaf);
mean_SonS_All_mse = mean(SprWithin_All_mfxval_mse);
ste_SonS_All_R2 = (std(SprWithin_All_mfxval_R2))/(sqrt(numVals));
ste_SonS_All_vaf = (std(SprWithin_All_mfxval_vaf))/(sqrt(numVals));
ste_SonS_All_mse = (std(SprWithin_All_mfxval_mse))/(sqrt(numVals));
...
[IonS_All_R2, ~, IonS_PredData, IonS_All_vaf, IonS_All_mse] = PeriodicR2(IsoModelAll,SprBinned,foldlength);
[WonS_All_R2, ~, WonS_PredData, WonS_All_vaf, WonS_All_mse] = PeriodicR2(WmModelAll,SprBinned,foldlength);
...
mean_IonS_All_R2 = mean(IonS_All_R2);
mean_IonS_All_vaf = mean(IonS_All_vaf);
mean_IonS_All_mse = mean(IonS_All_mse);
ste_IonS_All_R2 = (std(IonS_All_R2))/(sqrt(numVals));
ste_IonS_All_vaf = (std(IonS_All_vaf))/(sqrt(numVals));
ste_IonS_All_mse = (std(IonS_All_mse))/(sqrt(numVals));

mean_WonS_All_R2 = mean(WonS_All_R2);
mean_WonS_All_vaf = mean(WonS_All_vaf);
mean_WonS_All_mse = mean(WonS_All_mse);
ste_WonS_All_R2 = (std(WonS_All_R2))/(sqrt(numVals));
ste_WonS_All_vaf = (std(WonS_All_vaf))/(sqrt(numVals));
ste_WonS_All_mse = (std(WonS_All_mse))/(sqrt(numVals));
...
[HonS_All_R2, ~, HonS_PredData, HonS_All_vaf, HonS_All_mse] = PeriodicR2(HybModelAll,SprBinned,foldlength);
...
mean_HonS_All_R2 = mean(HonS_All_R2);
mean_HonS_All_vaf = mean(HonS_All_vaf);
mean_HonS_All_mse = mean(HonS_All_mse);
ste_HonS_All_R2 = (std(HonS_All_R2))/(sqrt(numVals));
ste_HonS_All_vaf = (std(HonS_All_vaf))/(sqrt(numVals));
ste_HonS_All_mse = (std(HonS_All_mse))/(sqrt(numVals));
