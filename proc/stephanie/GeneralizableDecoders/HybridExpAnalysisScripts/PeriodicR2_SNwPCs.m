function [R2, varargout] = PeriodicR2_SNwPCs(filter,binnedData,foldlength,varargin)
...
for i=1:nfold
    ...
    % create PCs and get vaf/mse for the PC prediction
    [Coeff,PCsnippet,Latent,Tsquared,Explained,Mu] = pca(Act);
...
varargout = {filter, PredData, vaf, mse, ActSignalsTrunk, PC_vaf, PC_mse PCsnippet predPCs};
