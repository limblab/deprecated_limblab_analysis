function TaskEMG_Isometric(binnedData,emg1,emg2,emg3,emg4,save,foldername, filename)
% TaskEMG_Isometric(IsoBinned,'FCU', 'FCR', 'ECU', 'ECR');
% TaskEMG_Isometric(IsoBinned,'FDS', 'FDP', 'ECU', 'ECR');
...
title(strcat(['Isometric ',binnedData.meta.datetime(1:9)]));
