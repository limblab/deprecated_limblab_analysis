...
BuildDecodersMakePredictions_weightingPCs
...
AllweightedAveVAF_HonI(z) = weightedAveVAF_HonI; AllweightedAveVAF_WonI(z) = weightedAveVAF_WonI; AllweightedAveVAF_IonI(z) = weightedAveVAF_IonI;
AllweightedAveVAF_HonW(z) = weightedAveVAF_HonW; AllweightedAveVAF_WonW(z) = weightedAveVAF_WonW; AllweightedAveVAF_IonW(z) = weightedAveVAF_IonW;
if SpringFile == 1
    AllweightedAveVAF_HonS(z) = weightedAveVAF_HonS; AllweightedAveVAF_WonS(z) = weightedAveVAF_WonS;
    AllweightedAveVAF_IonS(z) = weightedAveVAF_IonS; AllweightedAveVAF_SonS(z) = weightedAveVAF_SonS;
end

AllEigenVAF_HonI(z) = EigenVAF_HonI; AllEigenVAF_WonI(z) = EigenVAF_WonI; AllEigenVAF_IonI(z) = EigenVAF_IonI;
AllEigenVAF_HonW(z) = EigenVAF_HonW; AllEigenVAF_WonW(z) = EigenVAF_WonW; AllEigenVAF_IonW(z) = EigenVAF_IonW;
if SpringFile == 1
    AllEigenVAF_HonS(z) = EigenVAF_HonS; AllEigenVAF_WonS(z) = EigenVAF_WonS;
    AllEigenVAF_IonS(z) = EigenVAF_IonS; AllEigenVAF_SonS(z) = EigenVAF_SonS;
end
...
clearvars -except monkeyname BaseFolder SubFolder meanHonI_PC_mse meanIonI_PC_mse meanWonI_PC_mse meanHonW_PC_mse meanWonW_PC_mse meanIonW_PC_mse...
    ...
    AllweightedAveVAF_HonI AllweightedAveVAF_IonI AllweightedAveVAF_WonI ...
    AllweightedAveVAF_HonW AllweightedAveVAF_IonW AllweightedAveVAF_WonW ...
   AllweightedAveVAF_HonS AllweightedAveVAF_IonS AllweightedAveVAF_WonS AllweightedAveVAF_SonS ...
    AllEigenVAF_HonI AllEigenVAF_IonI AllEigenVAF_WonI ...
    AllEigenVAF_HonW AllEigenVAF_IonW AllEigenVAF_WonW ...
   AllEigenVAF_HonS AllEigenVAF_IonS AllEigenVAF_WonS AllEigenVAF_SonS ...
