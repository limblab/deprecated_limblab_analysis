...
function [HybridFinal AlteredIsoFinal AlteredWMFinal IsoTrain IsoTest WmTrain WmTest] = makeHybridFileFixed(File1, File2, scale)  %(iso , wm)
...
HybridFinal.scale = scale;


alteredDataIso.meta.filename =  'Hybrid';
...
alteredDataWM.meta.filename =  'Hybrid';
