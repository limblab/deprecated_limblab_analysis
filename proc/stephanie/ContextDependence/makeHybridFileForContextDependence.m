...
function [HybridFinal AlteredIsoFinal AlteredWMFinal] = makeHybridFileForContextDependence(File1, File2)  %(iso , wm)
...
alteredDataWM.timeframe(newIndexA : newIndexA+600-1,:) =  File2.timeframe(newIndexA:newIndexA+600-1,:  )  ;       
alteredDataIso.timeframe(newIndexA : newIndexA+600-1,:) = File1.timeframe(newIndexA:newIndexA+600-1,:  );
