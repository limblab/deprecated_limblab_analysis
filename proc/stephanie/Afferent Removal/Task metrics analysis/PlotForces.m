function PlotForces(LastTargetContact) 
...
for N = 1%:length(Goodtrialtable)
   ...
   % **** Go cue index will be off ****
SingleTrialPositionsX = forces(GoCueIndex(1,N):EndTrialIndex(1,N),2);
SingleTrialPositionsY = forces(GoCueIndex(1,N):EndTrialIndex(1,N),3);
