function PlotTruncatedForces(out_struct, plotmin, plotmax)
...
% Make a simplier variable name for the force data
forces = out_struct.force.data;
force2pos = forces(:,2:3)/18; force2pos = cat(2, forces(:,1), force2pos);
%=========================================================================%
...
SingleTrialPositionsX = force2pos(GoCueIndex(1,N):EndTrialIndex(1,N),2);
SingleTrialPositionsY = force2pos(GoCueIndex(1,N):EndTrialIndex(1,N),3);
%keyboard
