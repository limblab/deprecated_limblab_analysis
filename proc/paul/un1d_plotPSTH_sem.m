function psth = un1d_plotPSTH_sem(sortedunits,kin,binSize,alignCode)
%
...
if alignCode==0         % align to
    ...
    %     plot(timeBins,PSTH_large(ui,:)-PSTH_large_sem(ui,:),'r:');
%     plot(timeBins,PSTH_large(ui,:)+PSTH_large_sem(ui,:),'r:');
%     plot(timeBins,PSTH_small(ui,:)-PSTH_small_sem(ui,:),'b:');
%     plot(timeBins,PSTH_small(ui,:)+PSTH_small_sem(ui,:),'b:');
