...
%
%   y = filt_nodelay_highpass(x, sampling_freq, cutoff_freq)
%
%
%       


function y = filt_nodelay_highpass(x, sampling_freq, cutoff_freq)
...
Wn = fc/(fs/2);
[a b] = butter(order,Wn,'high'); % a, b are the coefficients of the filter
