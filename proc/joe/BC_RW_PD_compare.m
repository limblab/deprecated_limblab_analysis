...
RW_filename = '/Users/limblab/Documents/Joe Lancaster/MATLAB/s1_analysis/proc/joe/Pedro_S1_040-s_multiunit';
% BC_filename = 'D:\Data\Pedro\Pedro_BC_031-s_multiunit';
%BC_filename = 'D:\Data\Pedro\Pedro_BC_031-s_multiunit';
%BC_filename = 'D:\Data\Pedro\Pedro_BC_008-s_multiunit';

curr_dir = pwd;
cd '/Users/limblab/Documents/Joe Lancaster/MATLAB/s1_analysis/';
addpath('/Users/limblab/Documents/Joe Lancaster/MATLAB/s1_analysis/');
load_paths;
cd(curr_dir)
...
PD_distribution_plot({'GLM'},glm_pd_table)
