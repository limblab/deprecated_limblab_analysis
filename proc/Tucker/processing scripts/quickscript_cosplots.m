...
folderpath_base='E:\processing\CO_bump\BD efficacy checking\147Deg\';
matchstring='Kramer';
% %matchstring2='BC';
...
%  [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot(bdf.tt,bdf.tt_hdr,0,1,0,0);
...
% 
%  [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot(bdf.tt,bdf.tt_hdr,1,1,0,0);
%  temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
%   figure(H_cartesian)
% title('Psychometric cartesian 10uA inverted')
% 
%  [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot(bdf.tt,bdf.tt_hdr,2,1,0,0);
%  temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
% save(strcat(folderpath,'15ua_inverted.txt'),'temp','-ascii')
%   figure(H_cartesian)
% title('Psychometric cartesian 15uA inverted')
% 
%  [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot(bdf.tt,bdf.tt_hdr,3,1,0,0);
%  temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
...
% 
 ...
 %single hemispace
 [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot_compressed(bdf.tt,bdf.tt_hdr,0,1,0,0);
 temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
 figure(H_cartesian)
 ...
 [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot_compressed(bdf.tt,bdf.tt_hdr,1,1,0,0);
 temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
 figure(H_cartesian)
 ...
 [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot_compressed(bdf.tt,bdf.tt_hdr,2,1,0,0);
 temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
 figure(H_cartesian)
 ...
 [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_cartesian] =  bc_psychometric_curve_stim3_cosplot_compressed(bdf.tt,bdf.tt_hdr,3,1,0,0);
 temp=[dirs_stim,proportion_stim,number_reaches_stim,ones(length(dirs_stim),1);dirs_no_stim,proportion_no_stim,number_reaches_no_stim,zeros(length(dirs_no_stim),1)];
 figure(H_cartesian)
