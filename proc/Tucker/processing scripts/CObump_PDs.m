function [figure_list,data_struct]=CObump_PDs(folderpath,input_data)
    ...
    %% find bump periods
        ...
        bump_hold=bdf_multiunit.TT(:,bdf_multiunit.TT_hdr.bump_hold);
        mask=bump_onset>1;
    ...
    %% find move periods
        cue_times=bdf_multiunit(:,bdf_multiunit.TT_hdr.go_cue);
        end_times=bdf_multiunit(:,bdf_multiunit.TT_hdr.end_time);
        mask=cue_times>1;
