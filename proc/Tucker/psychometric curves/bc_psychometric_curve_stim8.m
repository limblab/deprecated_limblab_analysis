function [fitdata,H_2] = bc_psychometric_curve_stim8(tt,tt_hdr,stimcode,invert_dir)
    ...
    fitdata.g_stim_upper=g_stim_upper;
    fitdata.logpdf_stim_upper=logpdf_stim_upper;
    ...
    fitdata.g_stim_lower=g_stim_lower;
    fitdata.logpdf_stim_lower=logpdf_stim_lower;
    ...
    fitdata.g_no_stim_upper=g_no_stim_upper;
    fitdata.logpdf_no_stim_upper=logpdf_no_stim_upper;
    ...
    fitdata.g_no_stim_lower=g_no_stim_lower;
    fitdata.logpdf_no_stim_lower=logpdf_no_stim_lower;
