function [fitdata,H_2] = bc_psychometric_curve_stim8_compressed(tt,tt_hdr,stimcode,invert_dir)
    ...
    fitdata.proportion_stim=proportion_stim;
    fitdata.number_reaches_stim=number_reaches_stim;

    
    %set the angle interval on which the fit curves will be displayed
    dd = 0:.01:180;
    
    data_stim=[angs_stim,is_left_reach_stim];
    [g_stim,logpdf_stim]=get_ml_sigmoid(data_stim);  
    fitdata.g_stim=g_stim;
    fitdata.logpdf_no_stim=logpdf_stim;
    ...
    fitdata.dirs_no_stim=dirs_no_stim;
    fitdata.proportion_no_stim=proportion_no_stim;
    fitdata.number_reaches_no_stim=number_reaches_no_stim;
    %set the angle interval on which the fit curves will be displayed
    dd = 0:.01:180;
    ...
    data=[angs_no_stim,is_left_reach_no_stim];
    [g_no_stim,logpdf_no_stim]=get_ml_sigmoid(data);  
    fitdata.g_no_stim=g_no_stim;
    fitdata.logpdf_stim=logpdf_no_stim;
    ...
    logpdf_null=logpdf_sigmoid2(data_stim,g_no_stim);
    [h,pValue,stat,cValue] = lratiotest(-1*logpdf_stim,-1*logpdf_null,4,.05);
    fitdata.lratio.pValue=pValue;
    fitdata.lratio.stat=stat;
    fitdata.lratio.cValue=cValue;
    fitdata.lratio.h=h;
    figure(H_2);
