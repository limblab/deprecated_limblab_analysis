function [dirs_stim,proportion_stim,number_reaches_stim,dirs_no_stim,proportion_no_stim,number_reaches_no_stim,H_1] = bc_psychometric_curve_stim3_cosplot(tt,tt_hdr,stimcode,invert_dir,plot_error,invert_error)
