...
for i = 1:num_iter
    ...
    title_str = sprintf('%s - %s - %.1f min',train_data.meta.filename,train_duration(i)/60);
    ...
    switch type
        case 'normal'
            ...
            [vaf(i,:),R2(i,:),preds(:,:,i),~,figh(i,:)] = plot_predsF(test_data,{decoders{i};E2F},params.mode,1,1,0,title_str,1);
        case 'supervised'
            ...
            decoders{i} = N2F;
            [vaf(i,:),R2(i,:),preds(:,:,i),~,figh(i,:)] = plot_predsF(test_data,{N2F;[]},params.mode);
