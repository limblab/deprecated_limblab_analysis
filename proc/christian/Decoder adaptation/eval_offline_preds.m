...
%argin = {train_duration, 'conditions', 'save_path',params}
...
if nargin >5 params         = varargin{4}; end
...
for cond = 1:length(conditions)
    ...
    [vaf,R2,mse,preds,decoders,figh] = train_adapt_duration(traindata,testdata,60*train_duration,conditions{cond},params);
