...
filter = load('C:\Documents and Settings\Christian\Desktop\Adaptation2_new_sort\InitialNullFilter.mat');
...
for i = 1:length(Adapt_Lag)
    [R2(:,:,i), nfold] = mfxval_fixed_model(filter,binnedData,foldlength,Adapt_Enable,LR,Adapt_Lag(i));
end
