...
for class = 1:numclass
    ...
    predVar{1} = zeros(numrest,size(ActData,2));
    predVar{2} = zeros(nummvt,size(ActData,2));
...
%             actVar{state+1,class}(mvt_counter,:) = std(ActData(start:stop,:));
    ...
    predVar{1} = predVar{1,class}(1:rest_counter,:);
    predVar{2} = predVar{1,class}(1:mvt_counter,:);
%     actVar {1,class} =  actVar{1,class}(1:rest_counter,:);
%     actVar {2,class} =  actVar{1,class}(1:mvt_counter,:);
