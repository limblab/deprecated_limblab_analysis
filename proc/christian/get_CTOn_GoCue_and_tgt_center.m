function [CTOn_GoCue_ts_w_tgt_centers] = get_tgt_center(out_struct)

%% UNCODED YET---TODO----TODO----TODO----TODO----
%---TODO----TODO----TODO----TODO----
%---TODO----TODO----TODO----TODO----
%---TODO----TODO----TODO----TODO----
    ...
    %
    % ts is the time at which a 'CT_On' (Center Target On) or a 'End of trial' word was issue
    ...
    % get center ts
    % -------------%
    Center_ts = out_struct.words(out_struct.words(:,2)==w.CT_On,1);
    Center_ts(:,2:3)=0;
...
%         index = index+tmpNum_ts;
    ...
    CTOn_GoCue_ts_w_tgt_centers = sortrows([Center_ts;EOT_ts],1);
