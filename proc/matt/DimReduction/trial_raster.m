...
% [trial_raster,data] = trial_raster(units,trial_table,t1_pm,t2_pm) is a
% function that creates a raster (trial_raster) in cell array form. In
% addition, the second output 'data' is a struct containing trial number 
