...
function varargout = calculate_sta_metrics_matt( varargin )
...
%         plot_sta_matt( emg, force, sta_params, sta_metrics );
%     elseif ~sta_params.record_force_yn
%         plot_sta_matt( emg, sta_params, sta_metrics );
%     else
%         plot_sta_matt( force, sta_params, sta_metrics );
%     end
end