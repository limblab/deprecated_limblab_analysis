...
%     'MrT','2013-08-20','FF','RT'; ...   %2  S(P) x
%     'MrT','2013-08-21','FF','CO'; ...  %3  S(P) - AD is split in two. This was stitched together.
%     'MrT','2013-08-22','FF','RT'; ...   %4  S(P) x
%     'MrT','2013-08-23','FF','CO'; ...   %5  S(P)
%     'MrT','2013-08-30','FF','RT'; ...   %6  S(P) x
%     'MrT','2013-09-03','VR','CO'; ...   %7  S(P)
%     'MrT','2013-09-04','VR','RT'; ...   %8  S(P) x
%     'MrT','2013-09-05','VR','CO'; ...   %9  S(P)
%     'MrT','2013-09-06','VR','RT'; ...   %10 S(P) x
%     'MrT','2013-09-09','VR','CO'; ...   %11 S(P)
%     'MrT','2013-09-10','VR','RT'; ...   %12 S(P) x
    % 'MrT','2013-09-24','VRFF','RT'; ... %13 S(P) x
    % 'MrT','2013-09-25','VRFF','RT'; ... %14 S(P) x
    % 'MrT','2013-09-27','VRFF','RT'; ... %15 S(P) x
    % 'MrT','2013-10-11','VR','RT'; ...   %16 S(P) x - 45 degree visual rotation};
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% Chewie
...
% % % %     'Chewie','2013-12-13','VR','RT'; ... %16 S(M)
% % % %     'Chewie','2013-12-17','FF','RT'; ... %17 S(M)
% % % %     'Chewie','2013-12-18','FF','RT'; ... %18 S(M)
...
%     'Chewie','2015-06-29','FF','CO'; ... %30 S(M) - SHORT WASHOUT
    ...
    'Chewie','2015-07-08','FF','CO'; ... %36 S(M)
...
%     'Chewie','2015-07-16','VR','CO'; ... %42 S(M)
% %     'Chewie','2015-11-09','VR','CO'; ... %43 S(M) - +30 degree gradual rotation in 120 trials
...
% %     'Chewie','2015-11-13','VR','CO'; ... %46 S(M) - +30 degree gradual rotation in 240 trials
% %     'Chewie','2015-11-16','VR','CO'; ... %47 S(M) - +30 degree gradual rotation in 240 trials
% %     'Chewie','2015-11-17','VR','CO'; ... %48 S(M) - +30 degree gradual rotation in 240 trials
% %     'Chewie','2015-11-18','VR','CO'; ... %49 - +30 degree gradual rotation in 240 trials. Smaller target size.
% %     'Chewie','2015-11-19','VR','CO'; ... %50 - +60 degree sudden rotation. 
% %     'Chewie','2015-11-20','VR','CO'; ... %51 S(M) - +30 degree gradual rotation in 400 trials
% %     'Chewie','2015-12-01','VR','CO'; ... %52 - +45 degree sudden rotation
% %     'Chewie','2015-12-03','VR','CO'; ... %53 - +60 degree sudden rotation
% %     'Chewie','2015-12-04','VR','CO'; ... %54 - +45 degree sudden rotation
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% Mihili
...
% %    'Mihili','2015-12-11','FF','CO'; ...    %20 S(M-P) - SOMETHING SEEMS STREANGE IN BEHAVIOR
