function [timeCenters, uTimes] = getPercentBinCenters(trialTable, holdTime, winSize, stepSize, reqTrialNum)
...
for iCenter = 1:size(trialTable,1)
    
    t = trialTable(iTrial,8)-trialTable(iTrial,7)-holdTime;
