function hitRate=LFP_CorrAdjust_BCperformance(out_struct,H,P,bestc,bestf)

% syntax hitRate=LFP_CorrAdjust_BCperformance(out_struct);
%
...
%% Insert function to increase/decrease correlation between two signals
