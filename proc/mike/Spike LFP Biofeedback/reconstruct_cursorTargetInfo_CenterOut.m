...
%% To Do
% - Change words to reflect center out
% - Add second target check from center to outer target
% - Add Fails and Incompletes (currently only success and aborts)
% - Change target drawing variables (CO uses target corners instead of
% target centers
% - 
