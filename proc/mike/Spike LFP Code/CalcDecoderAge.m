...
for i = 1: size(Mini_LFP1filenames,1)
    
    [s, tokens] = regexp(Mini_LFP1filenames{i,2}, '[0-9]{1}','match','split')
    ...
    Mini_LFP1filenames{i,3} = datenum(Mini_DateNames{i}) - datenum('08-24-2011');
