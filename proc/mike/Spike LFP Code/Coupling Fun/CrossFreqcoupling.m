...
%     rSignalAvg(q) = cellfun(@mean,rtrialSig)
    ...
    [b_gamma,a_gamma]=butter(2,[30 100]/(samprate/2));
    ...
    [p_i_ThetaGamma(q,:)] = binAmpByPhase(PhaseMat_theta,AmpMat_gamma);
    [p_i_ThetaGamma2(q,:)] = binAmpByPhase(PhaseMat_theta,AmpMat_gamma2);
...
%     [C_Fail_end,phi,S12,S1,S2,f,zerosp]=cohgramcpt(Trial_Fail_FPendMAT,Trial_Fail_tsend,win,paramsFP);
    ...
    clear tfmat_gamma tfmat_gamma2 tfmat_theta AmpMat_gamma AmpMat_gamma2 PhaseMat_theta
