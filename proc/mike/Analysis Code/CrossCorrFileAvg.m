function [X_cross_corr_sortByDay_avg_99_sortByFreq Y_cross_corr_sortByDay_avg_99_sortByFreq]...
    = CrossCorrFileAvg(peakValAll_x_Chewie, peakValAll_y_Chewie, DecoderAges, featureIndex)

X_cross_corr = [peakValAll_x_Chewie DecoderAges'];
Y_cross_corr = [peakValAll_y_Chewie DecoderAges'];
...
X_cross_corr_sortByDay_avg_99_sortByFreq = [X_cross_corr_sortByDay_avg_99 featureIndex'];

Y_cross_corr_sortByDay_avg_99 = Y_cross_corr_sortByDay_avg(featindBEST,:);
Y_cross_corr_sortByDay_avg_99_sortByFreq = [Y_cross_corr_sortByDay_avg_99 featureIndex'];
...
title('X cross correlation sorted by Day and Freq Chewie HC')
set(gca,'XTick',[1:NumDays],'XTickLabel',DayLabel)
% figure
