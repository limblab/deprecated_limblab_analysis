function [X_cross_corr_sortByDay_avg_99_sortByFreq Y_cross_corr_sortByDay_avg_99_sortByFreq]...
    = CrossCorrFileAvg(peakValAll_x, peakValAll_y, DecoderAges, featindBEST, freqIndex)
...
X_cross_corr_sortByDay_avg_99_sortByFreq = [X_cross_corr_sortByDay_avg_99 freqIndex'];

Y_cross_corr_sortByDay_avg_99 = Y_cross_corr_sortByDay_avg(featindBEST,:);
Y_cross_corr_sortByDay_avg_99_sortByFreq = [Y_cross_corr_sortByDay_avg_99 freqIndex'];
...
figure; 
imagesc(X_cross_corr_sortByDay_avg_99_sortByFreq(1:end,1:end-1));figure(gcf);
title('X cross correlation with Online Predictions -- Mini')
set(gca,'XTick',[1:NumDays],'XTickLabel',DayLabel)
set(gca,'YTick',[1,23,46,60,78],'YTickLabel',{'LMP','Delta','70-110','130-200','200-300'})
caxis([0 1])

figure; 
imagesc(Y_cross_corr_sortByDay_avg_99_sortByFreq(1:end,1:end-1));figure(gcf);
title('Y cross correlation with Online Predictions -- Mini')
set(gca,'XTick',[1:NumDays],'XTickLabel',DayLabel)
set(gca,'YTick',[1,23,46,60,78],'YTickLabel',{'LMP','Delta','70-110','130-200','200-300'})
caxis([0 1])
% figure
% imagesc(X_cross_corr_sortByDay_avg_99_sortByFreq(71:120,1:end-1));figure(gcf);
