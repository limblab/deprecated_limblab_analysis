function [vaf,vmean,vsd,y_test,y_pred,varargout] = predictionsfromfp6_delta_only(sig, signal, numfp, binsize, folds,numlags,numsides,samprate,fp,fptimes,analog_times,fnam,varargin)
