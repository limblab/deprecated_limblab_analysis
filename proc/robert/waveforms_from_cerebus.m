function out_struct = waveforms_from_cerebus(varargin)
...
% $Id: get_cerebus_data.m 541 2011-06-28 18:51:40Z ricardo $
...
%% Open the file
    ...
    DateTime = [int2str(FileInfo.Time_Month) '/' int2str(FileInfo.Time_Day) '/' int2str(FileInfo.Time_Year) ...
     ...
     out_struct.meta = struct('filename', filename, 'datetime', ...
        ...
        'bdf_info', '$Id: get_cerebus_data.m 541 2011-06-28 18:51:40Z ricardo $');
