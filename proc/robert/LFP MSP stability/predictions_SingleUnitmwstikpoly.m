function [vaf, vmean,vsd,y_test,y_pred,varargout]=predictions_SingleUnitmwstikpoly(bdf, signal, cells, binsize, folds,numlags,numsides,lambda,PolynomialOrder,Use_Thresh,varargin)
%[cells]
    ...
    if  PolynomialOrder
        ...
        for z=1:size(y_pred{i},2)
            ...
            elseif ~exist('P','var')
                ...
                [P(z,:,i)] = WienerNonlinearity(y_pred{i}(:,z), ytnew{i}(:,z), PolynomialOrder);
            end
