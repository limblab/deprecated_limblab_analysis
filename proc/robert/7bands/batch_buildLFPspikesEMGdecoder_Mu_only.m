...
%     temg=(1/fse):(1/fse):(t2(end)+1/fse);
    ...
    [vaf,vmean,vsd,y_test,y_pred,r2mean,r2sd,r2,vaftr,bestf,bestc,H,bestfeat,x,y, ...
        ...
        predictionsfromfp6_Mu_only(sig,signal,numfp,binsize,folds,numlags,numsides, ...
    ...
    % were added.
    if exist('Mu_only','dir')==0, mkdir('Mu_only'), end
    save(['Mu_only\',fnam,'tik emgpred ',num2str(nfeat),' feats lambda',num2str(lambda),' poly',num2str(PolynomialOrder),'.mat'], ...
