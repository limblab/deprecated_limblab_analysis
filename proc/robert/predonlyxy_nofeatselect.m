function [vmean,vaf,vaftr,r2mean,r2sd,r2,y_pred,y_test,varargout]=predonlyxy_nofeatselect(x,y,PolynomialOrder,Use_Thresh,lambda,numlags,numsides,binsamprate,folds,smoothflag,varargin)
