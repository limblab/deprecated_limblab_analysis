function varargout = selectEEGelectrodes3(varargin)
% SELECTEEGELECTRODES3 M-file for selectEEGelectrodes3.fig
%      SELECTEEGELECTRODES3, by itself, creates a new SELECTEEGELECTRODES3 or raises the existing
%      singleton*.
%
%      H = SELECTEEGELECTRODES3 returns the handle to a new SELECTEEGELECTRODES3 or the handle to
%      the existing singleton*.
%
%      SELECTEEGELECTRODES3('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SELECTEEGELECTRODES3.M with the given input arguments.
%
%      SELECTEEGELECTRODES3('Property','Value',...) creates a new SELECTEEGELECTRODES3 or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before selectEEGelectrodes2_OpeningFunction gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to selectEEGelectrodes3_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help selectEEGelectrodes3

% Last Modified by GUIDE v2.5 18-Jun-2014 17:58:23

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @selectEEGelectrodes3_OpeningFcn, ...
                   'gui_OutputFcn',  @selectEEGelectrodes3_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before selectEEGelectrodes3 is made visible.
function selectEEGelectrodes3_OpeningFcn(hObject, eventdata, handles, varargin) %#ok<*INUSL>
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to selectEEGelectrodes3 (see VARARGIN)

% Choose default command line output for selectEEGelectrodes3
handles.output = '';
...
% UIWAIT makes selectEEGelectrodes3 wait for user response (see UIRESUME)
uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = selectEEGelectrodes3_OutputFcn(hObject, eventdata, handles) 
