function raw = get_raw_plx_eventsOnly(filename, opts)
...
% $Id: get_raw_plx.m 287 2010-09-24 21:46:08Z marc $
...
%     end
    ...
    % comment this out if we're not going to use this function for
    % hand-control files.  Otherwise, will need it.
    try
