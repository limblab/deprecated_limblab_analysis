...
%  PD_PLOT_SELECTION(UNIT_LIST,PDS,ERRS,MODDEPTH,CHANNEL_SELECTION)
...
u1 = varargin{1}; % unit list generated by unit_list.m
pds = varargin{2}; % pds
errs = varargin{3}; % errs
moddepth = varargin{4}; % moddepth, generated by : [pds, errs, moddepth]=glm_pds(bdf)
channel_selection = varargin{5}; % vector of channels you want plotted: [13, 15, 94]
