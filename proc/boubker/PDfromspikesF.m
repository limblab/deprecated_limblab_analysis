function [allfilesPDs]=PDfromspikesF(pathname,allroots, rewardword,startword,shiftstart,degres,timeaft,pvallim)

% this fuction generates a cell array called allfilesPDs :
