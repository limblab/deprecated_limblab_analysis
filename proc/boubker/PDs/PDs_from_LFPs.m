function [LFPfilesPDs]=PDs_from_LFPs(root,LFPs,fbandst,fbanden,startword,rewardword,shiftstart,lag,bin_size,pvallim)
...
% [LFPfilesPDs]=PDs_from_LFPs('\\165.124.111.234\data\Miller\Pedro_4C2\S1 Array\processed\Pedro_2011-06-17_RW_001',[1 10 95],[10,70,130,200,300],[50,110,190,290,390],18 ,32,0,0.05,0.2,0.05);
...
degres=30;%if you change degres here change it also in vector_sum_PDs_LFPs
...
LFPfilesPDs=cell(3,1);
 ...
 ypos2=data.pos(find(data.pos(:,1)>=rt+bin_size,1),3);
            ...
            for j=1:length(LFPs)
                ...
                LFPsample=LFP(rt*LFPrate+lag*LFPrate:rt*LFPrate+bin_size*LFPrate+lag*LFPrate);
