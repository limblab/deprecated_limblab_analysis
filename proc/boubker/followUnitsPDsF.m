function [allfilesPDs]=followUnitsPDsF(pathname,allroots,dates,stimch)
...
%     figure;compass(pdcartx,pdcarty);
    ...
    allfilesPDs{3,nr}=dates(nr);
clearvars -except allroots rn allfilesPDs pathname pathnameout dates
end

   followunitsPDswithcompassstimF3
end
