function [movementFRs, spontaneousFRs] = tuningCurve_2(...
    spikeTimes, eventTimes, eventDirections, holdStarts)
% tuningCurve_2 -
%
% INPUT:
%       'spikeTimes' - spike times (sec) (presumably from 'separateStimBlocks'
...
spikesInWindow =...
    bsxfun(@ge, spikeTimes, holdStarts') & bsxfun(@le, spikeTimes, eventTimes');
windowLengths =...
