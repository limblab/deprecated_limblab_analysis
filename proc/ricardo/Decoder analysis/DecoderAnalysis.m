    target_folder = ['D:\Jaco_8I1\Jaco_2016-02-10_RW_no_load\'];
    ...
    params.fig_handles = [];
    new_fs = 2000;
    %     threshold_vector = 2:.5:5;
    threshold_vector = 1:3;
% 
...
save([target_folder params.file_prefix '-VAFs_' num2str(new_fs)],'VAF','VAF_spikes','R2','R2_spikes',...
...
xlabel('Threshold (stds)')
ylabel('VAF')
title('VAF as a function of threshold')
ylim([0 1])
