...
if isfield(arm_params,'theta')
    musc_end_1_x = [arm_params.X_gain*arm_params.m_ins(1)*cos(arm_params.theta_ref(1))...
        arm_params.X_gain*arm_params.m_ins(1)*cos(arm_params.theta_ref(1)+pi)...
        arm_params.X_e(1)-arm_params.m_ins(1)*cos(arm_params.theta(:,1))...
        arm_params.X_e(1)+arm_params.m_ins(1)*cos(arm_params.theta(:,1))];
    musc_end_1_y = [arm_params.m_ins(1)*sin(arm_params.theta_ref(1))...
        arm_params.m_ins(1)*sin(arm_params.theta_ref(1)+pi)...
        arm_params.X_e(2)-arm_params.m_ins(1)*sin(arm_params.theta(:,1))...
        arm_params.X_e(2)+arm_params.m_ins(1)*sin(arm_params.theta(:,1))];
    musc_end_2_x = [arm_params.m_ins(1)*cos(arm_params.theta(:,1))...
        arm_params.m_ins(1)*cos(arm_params.theta(:,1))...
        arm_params.X_e(1)+arm_params.m_ins(1)*cos(arm_params.theta(:,2))...
        arm_params.X_e(1)+arm_params.m_ins(1)*cos(arm_params.theta(:,2))];
    musc_end_2_y = [arm_params.m_ins(1)*sin(arm_params.theta(:,1))...
        arm_params.m_ins(1)*sin(arm_params.theta(:,1))...
        arm_params.X_e(2)+arm_params.m_ins(1)*sin(arm_params.theta(:,2))...
        arm_params.X_e(2)+arm_params.m_ins(1)*sin(arm_params.theta(:,2))];
...
set(hFig.h_text,'String',{['t = ' num2str(arm_params.t_now) ' s']})   
drawnow