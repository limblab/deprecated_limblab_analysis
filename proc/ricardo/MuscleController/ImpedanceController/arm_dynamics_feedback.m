function xdot = arm_dynamics(t,x,arm_params)
...
if ~arm_params.monkey_control
    ...
    T_musc = [T_feedforward(1) + T_feedforward(3) + T_feedback(1) + T_feedback(3);...
        T_feedforward(2) + T_feedforward(3) + T_feedback(2) + T_feedback(3)];
else
