function [filt_struct, OffLPredData] = BuildFilter_reg(trainData,pred_out,input_type,PolynomialOrder,varargin)
...
if nargin>4
    lambda = varargin{1};
    [filt_struct, OffLPredData] = train_reg(trainData,dataPath,fillen,UseAllInputsOption,...
        PolynomialOrder,PredEMG, PredForce, PredCursPos,PredVeloc,input_type,lambda);
else
    [filt_struct, OffLPredData] = train_reg(trainData,dataPath,fillen,UseAllInputsOption,...
