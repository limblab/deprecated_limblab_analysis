function plot_path2T_GUI(varigin)
...
if all((x_HC(:,1)== x_N2E2P(:,1)) & (x_HC(:,1) == x_N2P(:,1)))
    ...
    boxplot_compareDecoders(t_HC,t_N2E2P,t_N2P,'Time to reach a target','s')
    boxplot_compareDecoders(length_HC,length_N2E2P,length_N2P,'Total length to reach a target','cm')
    
    figure();bar([st_HC;st_N2E2P;st_N2P],0.6);
