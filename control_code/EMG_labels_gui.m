function varargout = EMG_labels_gui(varargin)
% EMG_LABELS_GUI M-file for EMG_labels_gui.fig
%      EMG_LABELS_GUI, by itself, creates a new EMG_LABELS_GUI or raises the existing
%      singleton*.
%
%      H = EMG_LABELS_GUI returns the handle to a new EMG_LABELS_GUI or the handle to
%      the existing singleton*.
%
%      EMG_LABELS_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in EMG_LABELS_GUI.M with the given input arguments.
%
%      EMG_LABELS_GUI('Property','Value',...) creates a new EMG_LABELS_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before EMG_labels_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to EMG_labels_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help EMG_labels_gui

% Last Modified by GUIDE v2.5 10-Aug-2010 09:57:08

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @EMG_labels_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @EMG_labels_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before EMG_labels_gui is made visible.
function EMG_labels_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to EMG_labels_gui (see VARARGIN)

% Choose default command line output for EMG_labels_gui
...
% UIWAIT makes EMG_labels_gui wait for user response (see UIRESUME)
 uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = EMG_labels_gui_OutputFcn(hObject, eventdata, handles) 
