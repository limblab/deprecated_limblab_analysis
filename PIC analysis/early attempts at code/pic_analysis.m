...
%within_avgy(wt)=mean(preD_preF.preddatabin(find(preD_preF.timeframe>pre_caff_bdf.words(i,1)-holdtime,1):find(preD_preF.timeframe> pre_caff_bdf.words(i,1),1),2));
%across_avgy(wt)=mean(preD_postF.preddatabin(find(preD_postF.timeframe>pre_caff_bdf.words(i,1)-holdtime,1):find(preD_postF.timeframe> pre_caff_bdf.words(i,1),1),2));
