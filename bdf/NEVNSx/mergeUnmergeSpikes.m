...
file_prefix_all = 'Kevin_2013-10-07_';
...
while strcmp(mergingStatus,'merged spikes')
    ...
    disp(['Sort ''' file_prefix '-spikes.nev'' in OfflineSorter and save sorted file as '''...
        file_prefix '-spikes-s.nev'' then press any key to continue.'])
    pause
