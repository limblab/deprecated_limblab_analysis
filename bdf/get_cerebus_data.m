...
% GET_PLEXON_DATA Generates Brian's datastructure from nev and ns* files
%   OUT_STRUCT = GET_CEREBUS_DATA(FILENAME) returns Brian's datastructure
%   read from the PLX file FILENAME.
%
%   OUT_STRUCT = GET_CEREBUS_DATA(FILENAME, VERBOSE) returns Brian's
%   datastructure read from the file FILENAME and outputs status
...
% $Id: get_plexon_data.m 32 2009-01-22 22:15:09Z brian $
