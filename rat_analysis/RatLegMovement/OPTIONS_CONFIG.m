...
OPTS.VICONDIRECTORY = 'C:\Users\mkj605\Documents\GitHub\RatLegMovement\RatLegMovement';
...
dataset.NAME = 'Rat treadmill';
dataset.FNAME_ROOT = '2-19-16';
dataset.LIST{1} = [01 03];
dataset.MARKERIND = {1:6};
dataset.MARKERLABEL = {'leg'};
